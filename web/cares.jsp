    ...
    <a href="http://localhost:8080/FYP_UniversityLifehacksWebsite/AccountPage/accountpage.jsp">Account</a>
       ...
       if (uid == null){
        ...
        <h2 style="text-align:center;   color:  #625D5D;
            font-family: 'Arsenal', sans-serif;"> Self Care Tips</h2>

        <div> 
            <table style="align:center" id="cares" class="table">
                <tr> 
                    ...
                    <tr>
                        ...
                        <td>  
                            <form action="LikeServlet" method="post">
                                <input type="hidden" name="tipID" value="${c.getTipID()}">
                                <input type="hidden" name="like" value="${c.getLike()}">
