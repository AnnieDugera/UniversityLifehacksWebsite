    ...
    <a href="http://localhost:8080/FYP_UniversityLifehacksWebsite/AccountPage/accountpage.jsp">Account</a>
       ...
       if (uid == null){
        ...
        <h2 style="text-align:center;   color:  #625D5D;
            font-family: 'Arsenal', sans-serif;"> Money Saving Tips</h2>

        <div> 
            <table style="align:center" id="moneys" class="table">
                <tr> 
                    ...
                    <tr>
                        ...
                        <td>  
                            <form action="LikeServlet" method="post">
                                <input type="hidden" name="tipID" value="${m.getTipID()}">
                                <input type="hidden" name="like" value="${m.getLike()}">
