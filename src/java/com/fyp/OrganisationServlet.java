...
public class OrganisationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HackDAO od = new HackDAO();
       ArrayList<Hack> organs = od.getOrganisation();
        Collections.sort(organs, Collections.reverseOrder());
    ...
    /*    
     ArrayList<Hack> HACKTOP10 = new ArrayList <Hack>();
        ...
        */
        ...
        session.setAttribute("organs", organs);
        
        response.sendRedirect("organs.jsp");
        }
