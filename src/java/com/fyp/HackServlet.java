 ...
 * @author macke
 */
@WebServlet(name = "HackServlet", urlPatterns = {"/HackServlet"})
public class HackServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HackDAO ud = new HackDAO();
       ArrayList<Hack> hacks = ud.getHacks();
     ...
     ArrayList<Hack> HACKTOP10 = new ArrayList <Hack>();
        ...
        //response.sendRedirect(".Web Pages/WEB-INF/hacks_served.jsp");
        RequestDispatcher rd=request.getRequestDispatcher("./WEB-INF/hacks_served.jsp");  
