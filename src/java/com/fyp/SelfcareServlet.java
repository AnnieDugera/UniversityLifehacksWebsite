 ...
 * @author macke
 */
@WebServlet(name = "SelfcareServlet", urlPatterns = {"/SelfcareServlet"})
public class SelfcareServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HackDAO cd = new HackDAO();
       ArrayList<Hack> cares = cd.getSelfCare();
        Collections.sort(cares, Collections.reverseOrder());
    ...
    /*    
     ArrayList<Hack> HACKTOP10 = new ArrayList <Hack>();
        ...
        */
        ...
        session.setAttribute("cares", cares);
        
        response.sendRedirect("cares.jsp");
        }
